      ...
      <div className="grid xl:grid-cols-2 gap-8 text-sm px-8">
        <div className="grid grid-rows-2 gap-8 items-start w-full xl:w-3/4">
          <div className="flex gap-2 items-center">
            ...
            <p className="md:text-xl"> <span className="font-saudagar">Perspectives COWORKING</span> se charge de positionner votre entreprise au niveau de l&apos;Excellence grâce à vos bureaux.</p>
          </div>
        ...
        <div className="grid grid-rows-2 gap-8">
          <p><span className="font-saudagar">Perspectives COWORKING</span> c&apos;est la location de bureaux flexibles (partagés comme privés, modulables et personnalisables selon vos souhaits). Une solution clé en main pour les porteurs de projets en Côte-d&apos;Ivoire avant ou après leur immatriculation au CEPICI. Perspectives COWORKING vous offre pendant votre passage une connexion internet Premium, une propreté de vos locaux irréprochable ainsi qu&apos;une équipe dédiée à vos petits soins.
          </p>
