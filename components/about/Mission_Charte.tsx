    ...
    return (
        <section className="container min-h-[300px] py-14 relative">
            ...
            <div className="bg-black">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg row-span-2" src="/images/perspective/Bureaux privés/Bureau prospérité/img_p (3).jpg" alt="office content 1" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/perspective/Espace Bulle Open space/img (1).jpg" alt="office content 2" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/perspective/Bureaux privés/Bureau détermination/img (1).jpg" alt="office content 2" />
                    </div>
                </div>
            </div>
            <div className="relative gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img className="w-full" src="/images/perspective/Bureaux privés/Bureau confiance/img (2).jpg" alt="dashboard image" />
