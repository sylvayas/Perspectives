                ...
                flex justify-center flex-col">
                    ...
                    <div>
                        <p className="text-left mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400 text-custom-justify">
                            Perspectives coworking est un tiers lieu à la disposition de l&apos;écosystème entrepreneurial ivoirien fondé en 2024 par Edyeh ANOUMAN KACOU Experte en organisation professionnelle et valorisation clientèle.
                ...
                <dl className="col-span-2 mt-16  grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                    <div className="relative pl-6 md:pl-16 row-span-2">
                        <dt className="text-base font-semibold leading-7 text-gray-900">
                            <div className="absolute -left-4 -top-8 flex h-8 w- md:h-10 w-md:10 items-center justify-center rounded-lg bg-Perspectives_green">
                            </div>
