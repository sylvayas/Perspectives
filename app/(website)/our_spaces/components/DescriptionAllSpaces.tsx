    ...
    return (
        <section className="container min-h-[300px] py-14 relative">
            ...
            <div className="relative gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img className="w-full" src="/images/perspective/Bureaux privés/Bureau confiance/img (1).jpg" alt="dashboard image" />
            ...
            <div className="relative flex flex-col-reverse md:gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <div className="mt-4 md:mt-0">
                    ...
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                    Travailler en open space chez Perspectives, 
                ...
                <img className="w-full" src="/images/perspective/Espace Bulle Open space/img (1).jpg" alt="dashboard image" />
            </div>

            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img className="w-full" src="/images/perspective/Salle de réunion/img (1).jpg" alt="dashboard image" />
                <div className="mt-4 md:mt-0">
                    <h2 className="mb-4  text-2xl md:text-4xl tracking-tight font-saudagar">Salle de réunion</h2>
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                        Vous souhaitez pouvoir recevoir du monde afin d&apos;y organiser des réunions ? Perspectives vous donne la possibilité de pouvoir louer cette salle de réunion moderne dans Abidjan <br />
            ...
            <div className="relative flex flex-col-reverse md:gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <img className="w-full" src="/images/perspective/Espace commun/img (1).jpg" alt="dashboard image" />
            </div>
            ...
            {/* <div className="bg-black">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg row-span-2" src="/images/perspective/Bureaux privés/Bureau prospérité/Bureau Prospérité 2.jpg" alt="office content 1" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/perspective/Bureaux privés/Bureau détermination/IMG_5236[1].jpg" alt="office content 2" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/perspective/Bureaux privés/Bureau détermination/IMG_5236[1].jpg" alt="office content 2" />
                    </div>
                </div>
            </div> */}
